//思路：
//    1.html部分，主要是设计一个3d盒子
//    2.js部分先随机让一张图片居中，其他的分两边随机排列
//    3.让图片和圆点关联，并且，没变动一次，让图片和圆点都正面显示
//    4.写两个函数，让图片和圆点同时正面，同时背面
//    5.点击图片：1.如果是中间的那张，图片和圆点都反面。2.不是中间的就让他在中间区，并且圆点也相应有反应，让图片和圆点都正面显示
//    6.点击圆点：1.如果圆点对应的是中间那张，就和图片一起翻面，否则就让圆点对应的图片在中间，并且图片和圆点都正面显示
//
//技术：
//    html：
//        -webkit-perspective:800px;          /*增加3d效果*/  放在最外层盒子
//         -webkit-transform-style:preserve-3d;        /*变成3d盒子*/  放在要翻转那个盒子
//        -webkit-backface-visibility: hidden;            /*当元素不面向屏幕时，隐藏*/ 放在两面
//
//    js：
//        Math.random()


//代码的顺序很重要，如果你定义的变量在东西出来之前，那么你定义的变量将没有用
